...
python3 generate_bin_Armatus.py -i ${Armatus_path}/${data}/${data}.${noise}noise.consensus.txt -o bin/Armatus/${data}.${noise}.chr5 -r 40000
...
python3 generate_bin_Armatus.py -i ${Armatus_path}/bench/bench_armatus.chr${data}.consensus.txt -o bin/Armatus/benchmark.${data} -r 40000
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_CaTCH_EAST.py -i ${CaTCH_path}/${data}/${data}.${noise}noise -o bin/CaTCH/${data}.${noise}.chr5 
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_CaTCH_EAST.py -i ${CaTCH_path}/bench/bench_CaTCH.chr${data} -o bin/CaTCH/benchmark.${data}
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_CaTCH_EAST.py -i ${EAST_path}/${data}/${data}.${noise}noise -o bin/EAST/${data}.${noise}.chr5 
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_CaTCH_EAST.py -i ${EAST_path}/bench/bench_EAST.chr${data} -o bin/EAST/benchmark.${data}
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_GMAP.py -i ${GMAP_path}/${data}/${data}.${noise}noise -o bin/GMAP/${data}.${noise}.chr5 -r 40000
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_GMAP.py -i ${GMAP_path}/bench/bench_GMAP.chr${data} -o bin/GMAP/benchmark.${data} -r 40000
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_HiCExplorer.py -i ${HiCExplorer_path}/${data}/${data}.${noise}noise_domains.bed -o bin/HiCExplorer/${data}.${noise}.chr5 -r 40000
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_HiCExplorer.py -i ${HiCExplorer_path}/bench/bench_HiCExplorer.chr${data}_domains.bed -o bin/HiCExplorer/benchmark.${data} -r 40000
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_Matryoshka.py -i ${Matryoshka_path}/${data}/${data}.${noise}noise.consensus.txt -o bin/Matryoshka/${data}.${noise}.chr5 -r 40000
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_Matryoshka.py -i ${Matryoshka_path}/bench/bench_Matryoshka.chr${data}.consensus.txt -o bin/Matryoshka/benchmark.${data} -r 40000
done
...
for data in ${simulate_data[@]}; do
for noise in ${noiselist[@]}; do
python3 generate_bin_TADBD.py -i ${TADBD_path}/${data}/${data}.${noise}noise -o bin/TADBD/${data}.${noise}.chr5 
done
done

#for benchmarks
for data in ${benchList[@]}; do
python3 generate_bin_TADBD.py -i ${TADBD_path}/bench/bench_TADBD.chr${data} -o bin/TADBD/benchmark.${data}
done
